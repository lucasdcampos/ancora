    ...
    <div className="rounded-lg bg-white p-6 shadow-sm border border-slate-200 flex flex-col">
      ...
      <div className="flex gap-2 mt-auto">
        <button
          ...
          className="flex-1 rounded border border-slate-300 bg-white py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors shadow-sm flex items-center justify-center gap-2"
        >
